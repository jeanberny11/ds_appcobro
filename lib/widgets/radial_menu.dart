...
import 'package:ds_appcobro/widgets/arc_progress_indicator.dart';
import 'package:ds_appcobro/widgets/flutter_radial_menu.dart';
import 'package:ds_appcobro/widgets/radial_menu_button.dart';
import 'package:ds_appcobro/widgets/radial_menu_center_button.dart';
...
class RadialMenu<T> extends StatefulWidget {
  ...
  const RadialMenu({
    ...
    this.progressAnimationDuration = const Duration(milliseconds: 400),
    this.onMenuOpened,
    this.onMenuClosed,
    this.initopen=false
  })  : assert(radius != null),
